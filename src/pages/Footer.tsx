...
const Footer = () => {
  return (
    <div className="flex flex-col  bg-white sm:px-4 gap-4 border-b-8 border-[#006666]">
      <div className="flex flex-wrap lg:flex-nowrap justify-center sm:justify-between items-center gap-8 border-b-2 border-t-2 border-gray-300 pb-3 ">
        <div className="max-w-full w-full lg:max-w-56  flex justify-center">
          <img
            src={logo}
            alt="logo"
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:justify-between lg:justify-evenly sm:w-full">
          {/* legals */}
          <div className="flex flex-col gap-4">
            <div>
              <div className="font-semibold text-xl text-black uppercase">
                Legals:
              </div>
              <Link
                to="/terms-and-conditions"
                className="flex justify-start gap-2 items-center text-black"
              >
                <FaRegFileAlt />
                Terms & Conditions
              </Link>
      ...
      <div className="flex justify-center md:justify-between items-center align-middle pb-6 flex-wrap-reverse">
        <p className="text-[#000000] w-full border-t-2 border-gray-300 sm:w-auto text-center sm:border-none pt-3">
        ...
        <div className="flex justify-center items-center gap-2 w-full sm:w-auto pb-3 sm:pb-0">
          ...
          <a
            ...
            rel="no-refferer"
          >
            <img src={social2} alt="social logo" className="w-5 h-5"></img>
          </a>
          <a
            ...
            rel="no-refferer"
          >
            <img src={social3} alt="social logo" className="w-5 h-5"></img>
          </a>
          <a
            ...
            rel="no-refferer"
          >
            <img src={social4} alt="social logo" className="w-5 h-5"></img>
          </a>
          <a href="https://x.com/edubuktrust" target="_blank" rel="no-refferer">
            <img src={social5} alt="social logo" className="w-5 h-5"></img>
          </a>
          <a
            ...
            rel="no-refferer"
          >
            <img src={social6} alt="social logo" className="w-5 h-5"></img>
          </a>
        </div>
      </div>
    </div>
